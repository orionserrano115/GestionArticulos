...
<body>
    ...
    <form id="formArticulo" method="POST">
        ...
        <!-- Código eliminado del formulario porque es autoincremental -->
    ...
    <script>
        function editarArticulo(codigo, nombre, marca, cantidad, bodega) {
            ...
            // Para edición, guardamos el código en un campo oculto
            let hiddenCodigo = document.getElementById("codigoHidden");
            if (!hiddenCodigo) {
                hiddenCodigo = document.createElement("input");
                hiddenCodigo.type = "hidden";
                hiddenCodigo.name = "codigo";
                hiddenCodigo.id = "codigoHidden";
                document.getElementById("formArticulo").appendChild(hiddenCodigo);
            }
